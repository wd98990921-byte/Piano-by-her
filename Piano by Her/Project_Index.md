...
- [Space Overview](./Space/Space_Overview.md): 空间总览与跨区域关系。
- [Arrival](./Space/Arrival/Arrival.md): 到店与进入体验。
- [Journey Room](./Space/Journey%20Room/JourneyRoom.md): Session 01 核心体验空间。
- [Landing Room](./Space/Landing%20Room/LandingRoom.md): Session 后沉淀与过渡空间。
- [Cafe](./Space/Cafe/Cafe.md): 基础休息与陪伴区域。
- [装修 & 采购](./Space/装修%20&%20采购/Renovation_Procurement.md): 落地所需装修与采购。
